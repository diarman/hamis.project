...
/**
 * ConsultationProductsFixture
 *
 */
class ConsultationProductsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'posolgy' => ['type' => 'string', 'length' => 254, 'default' => null, 'null' => true, 'collate' => null, 'comment' => null, 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['product_id', 'consultation_id'], 'length' => []],
            'consultation_products_consultation_id_fkey' => ['type' => 'foreign', 'columns' => ['consultation_id'], 'references' => ['consultations', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'consultation_products_product_id_fkey' => ['type' => 'foreign', 'columns' => ['product_id'], 'references' => ['products', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
    ];
    ...
    public $records = [
        [
            ...
            'posolgy' => 'Lorem ipsum dolor sit amet',
