...
class VacationsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'reason' => ['type' => 'text', 'length' => null, 'default' => null, 'null' => true, 'collate' => null, 'comment' => null, 'precision' => null],
        ...
        '_constraints' => [
            ...
            'vacations_staff_id_fkey' => ['type' => 'foreign', 'columns' => ['staff_id'], 'references' => ['staffs', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
    ];
