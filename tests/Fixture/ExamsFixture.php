...
class ExamsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'exam_type_id' => ['type' => 'integer', 'length' => 10, 'default' => null, 'null' => false, 'comment' => null, 'precision' => null, 'unsigned' => null, 'autoIncrement' => null],
        ...
        '_constraints' => [
            ...
            'exams_exam_type_id_fkey' => ['type' => 'foreign', 'columns' => ['exam_type_id'], 'references' => ['exam_types', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
    ];
