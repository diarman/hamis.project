 ...
 * Rooms Model
 *
 * @property \App\Model\Table\PavillonsTable|\Cake\ORM\Association\BelongsTo $Pavillons
...
class RoomsTable extends Table
{
    ...
    {
        $rules->add($rules->existsIn(['pavillon_id'], 'Pavillons'));
