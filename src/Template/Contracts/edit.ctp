          ...
          <div class="box-body">
            <div class="col-md-6">
              <?php
                ...
                echo $this->Form->input('start_date', ['empty' => true, 'default' => '', 'class' => 'datepicker form-control', 'type' => 'date']);
                echo $this->Form->input('end_date', ['empty' => true, 'default' => '', 'class' => 'datepicker form-control', 'type' => 'date']);
