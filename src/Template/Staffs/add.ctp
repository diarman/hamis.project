  ...
  <div class="row">
    ...
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <?= $this->Form->create($staff, array('role' => 'form')) ?>
          <div class="box-body">
          <div class="row">
            <div class="col-md-6">
              <?php 
                  echo $this->Form->input('user_id', ['options' => $users]);
                  echo $this->Form->input('job_function_id', ['options' => $jobFunctions]);
                echo $this->Form->input('service_id', ['options' => $services]);
              ?>
            </div>
            <div class="col-md-6">
              <?php 
                echo $this->Form->input('hire_date', ['empty' => true, 'default' => '', 'class' => 'datepicker form-control', 'type' => 'text']);
